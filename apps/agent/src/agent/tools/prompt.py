...
SYSTEM_PROMPT = (
    ...
    " parameters.authentication='genericCredentialType' and, when you know the scheme,"
    " parameters.genericAuthType: httpHeaderAuth for API keys / bearer tokens,"
    " httpBasicAuth for username+password, httpQueryAuth for an api_key query parameter,"
    " httpCustomAuth for complex cases. Always use the real endpoint URL.\n"
