...
SYSTEM_PROMPT = (
    ...
    " message information is missing, call request_user_input for the first missing"
    " detail only; never invent it. For daily schedules, use trigger kind schedule"
    " with frequency daily and time HH:MM."
