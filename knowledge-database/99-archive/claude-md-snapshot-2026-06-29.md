# [ARŞİV] CLAUDE.md anlık görüntüsü — 2026-06-29

> Bu, workspace refactor **Faz 2** (agent-yönerge konsolidasyonu) sırasında
> inceltilmeden **önceki** root `CLAUDE.md`'nin tam kopyasıdır (552 satır).
> Kanonik agent rehberi artık `AGENTS.md`, kalıcı proje hafızası
> `knowledge-database/index.md`. Aşağıdaki "Son oturum özeti" kronolojisi
> **tarihsel referans** içindir; güncel durum için ilgili ADR/feature/durum
> notlarına bakın. İlgili: [[workspace-refactor]], [[agent-instructions]].
